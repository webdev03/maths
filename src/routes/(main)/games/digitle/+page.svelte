...
<div class="p-2">
  ...
  <p>
    This game is similar to the popular word game Wordle. In this game, rather than using the alphabet to construct
    words, you use the digits 0-9 to find the missing number.
  </p>
  <p>
    ...
    <span class="text-yellow-400">yellow</span>, then the target number has a digit with the same value, but in a
    different place. Otherwise, the digit does not appear in the target number.
  </p>
